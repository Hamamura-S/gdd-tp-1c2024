...
CREATE PROCEDURE GESTIONANDING.MIGRAR_TICKET_DET            --hay colisiones aca
AS
BEGIN
    ...
    WHERE TICKET_DET_CANTIDAD is not null AND CAJA_NUMERO IS NOT NULL
END
GO
...
BEGIN
    ...
    SELECT distinct
        p.PROMO_CODIGO, --FK
        td.TICKET_DET_PRODUCTO, --FK
        td.TICKET_DET_TICKET, --FK
    ...
    JOIN GESTIONANDING.TICKET_DET td ON
        ...
        AND td.TICKET_DET_TICKET=m.TICKET_NUMERO
