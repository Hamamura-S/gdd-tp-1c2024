...
AS
BEGIN
    INSERT INTO DETALLE_PAGO (DETPAG_CLIE, DETPAG_TARJETA, DETPAG_CUOTAS)
    SELECT DISTINCT 
        c.CLIENTE_ID,
        ta.TARJETA_ID, 
        m1.PAGO_TARJETA_CUOTAS
    FROM 
        ...
        JOIN gd_esquema.Maestra m2 
            ON  m1.TICKET_NUMERO = m2.TICKET_NUMERO
                ...
                AND m1.TICKET_SUBTOTAL_PRODUCTOS = m2.TICKET_SUBTOTAL_PRODUCTOS
                AND m1.TICKET_TOTAL_DESCUENTO_APLICADO = m2.TICKET_TOTAL_DESCUENTO_APLICADO
                AND m1.TICKET_TOTAL_DESCUENTO_APLICADO_MP = m2.TICKET_TOTAL_DESCUENTO_APLICADO_MP
                AND m1.TICKET_TOTAL_ENVIO = m2.TICKET_TOTAL_ENVIO
                AND m1.TICKET_TOTAL_TICKET = m2.TICKET_TOTAL_TICKET
