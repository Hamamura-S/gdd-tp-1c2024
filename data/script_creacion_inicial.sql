...
ALTER TABLE GESTIONANDING.ENVIO
    ADD CONSTRAINT FK_ENVIO_CLIENTE FOREIGN KEY (envio_cliente) REFERENCES GESTIONANDING.CLIENTE (cliente_id)
GO
...
ALTER TABLE GESTIONANDING.DETALLE_PAGO
    ADD CONSTRAINT FK_DETPAG_TARJETA FOREIGN KEY (detpag_tarjeta) REFERENCES GESTIONANDING.TARJETA (tarjeta_id)
GO

ALTER TABLE GESTIONANDING.PAGO
    ADD CONSTRAINT FK_PAGO_MP FOREIGN KEY (pago_medio_pago) REFERENCES GESTIONANDING.MEDIO_PAGO (mp_id)
GO
...
ALTER TABLE GESTIONANDING.PAGO
    ADD CONSTRAINT FK_PAGO_DETALLE FOREIGN KEY (pago_detalle) REFERENCES GESTIONANDING.DETALLE_PAGO (detpag_id)
GO
...
ALTER TABLE GESTIONANDING.DESCUENTO_APLICADO
    ADD CONSTRAINT FK_DA_DESCUENTO FOREIGN KEY (da_descuento) REFERENCES GESTIONANDING.DESCUENTO (descuento_codigo)
GO
...
ALTER TABLE GESTIONANDING.TICKET
    ADD CONSTRAINT FK_TICKET_EMPLEADO FOREIGN KEY (ticket_empleado) REFERENCES GESTIONANDING.EMPLEADO (empleado_legajo)
GO
...
ALTER TABLE GESTIONANDING.TICKET_DET
    ADD CONSTRAINT FK_TDET_TICKET FOREIGN KEY (ticket_det_ticket) REFERENCES GESTIONANDING.TICKET (ticket_numero)
GO
