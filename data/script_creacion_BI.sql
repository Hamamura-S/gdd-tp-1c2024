...
IF OBJECT_ID('BI_GESTIONANDING.BI_GESTIONANDING.CINCO_LOCALIDADES_CON_MAYOR_COSTO_ENVIO', 'V') IS NOT NULL
    DROP VIEW BI_GESTIONANDING.BI_GESTIONANDING.CINCO_LOCALIDADES_CON_MAYOR_COSTO_ENVIO
GO
